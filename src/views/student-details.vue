<template>
  <div>
    ...
    <div class="scrollable" dir="rtl">
      ...
      <p class="notice">اضغط على اسم المجموعة لاستعراض سجل الحضور بها</p>
      <div class="p-3">
        <div
          ...
          :class="{choosenRow: group._id == choosenGroup}"
        >
          <div class="col-md-1">
            {{ i + 1 }}
          </div>
    ...
    <div class="logss" dir="rtl">
      <h3 class="heading">
        سجل حضور الطالب (<span
          ...
          @click="() => {student_log = studentAttendanceLog; choosenGroup = null}"
          >الكل</span
        >)
      </h3>
      <p class="notice">اضغط على (كل) لأستعراض سجل حضور كل المجموعات</p>
      <div class="p-3">
