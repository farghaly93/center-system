    ...
    <div class="exams" dir="rtl">
      ...
      <div class="scrollable p-3 my-4">
        <h3 class="text-center">
          اضغط على اسم المجموعة لاستعراض الطلبة الملتحقين بها
        </h3>
        <hr>
        <div @click="getStudents(exam.groupId, exam.date, exam._id)" v-for="(exam, i) in filteredExams" :key="exam._id" class="exam row px-3" :class="{choosenRow: choosenExam == exam._id}">
          <div class="col-md-1">
            {{ i + 1 }}
          </div>
          <div class="col-md-2">
...
export default {
  ...
  methods: {
    ...
    getStudents(groupId, date, examId) {
      this.choosenExam = examId;
